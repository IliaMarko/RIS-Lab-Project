...
class PublishThread(threading.Thread):
    def __init__(self, rate):
        print('ForceControllerNode: initializing node')
    ...
    def run(self):
        ...
        while not self.done:
            ...
            force_msg.force.x = self.x * self.speed
            force_msg.force.y = self.y * self.speed
            force_msg.force.z = self.z * self.speed
            force_msg.torque.x = 0
            force_msg.torque.y = 0
            force_msg.torque.z = self.th * self.turn
